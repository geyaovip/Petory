...
import { ALLOWED_EXTENSIONS, CONTENT_SAFETY, MAX_UPLOAD_BYTES } from '@shared/constants'
  ...
  return (
    <PageShell>
      ...
      <h1 className="text-[22px] font-semibold">
        {replaceMode ? ONBOARDING_COPY.upload.titleReplace : ONBOARDING_COPY.upload.titleNew}
      </h1>
