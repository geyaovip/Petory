...
> **当前状态**：**B1.3** + **PostgreSQL**；客户端 **C2.3 / 2.1.0** 体验收口（见 [C2.3.md](../C2.3.md)、[QA-INTERNAL.md](../QA-INTERNAL.md)）。
...
| [B1.0.md](./B1.0.md) | B1.0 交付说明 |
| [B1.1.md](./B1.1.md) | B1.1 交付说明 |
| [B1.2.md](./B1.2.md) | B1.2 交付说明（Kimi 代理） |
| [B1.3.md](./B1.3.md) | **B1.3 已交付范围**（运营配置） |
| [VERSION-ROADMAP.md](./VERSION-ROADMAP.md) | 管理端版本规划与客户端协同节奏 |
...
| 客户端功能说明 | [../FEATURES.md](../FEATURES.md) |
| 客户端版本历史 | [../versions/README.md](../versions/README.md) |
